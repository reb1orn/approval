<style>
	...
	ul.ztree {width:100%;height:auto;}

	.ztree * {padding:0; margin:0; font-size:15px; font-family: Verdana, Arial, Helvetica, AppleGothic, sans-serif}
	.ztree {margin:0; padding:5px; color:#333 ;}
	.ztree li{position: relative; padding:0; margin:0; list-style:none; line-height:30px; text-align:left; white-space:nowrap; outline:0}
	...
	.ztree li a:hover {color:#E7744A;}
	.ztree li a.curSelectedNode {padding-top:0px; background-color:#e7744a; color:#fff; height:30px; border:1px #e7744a solid; opacity:0.8;}
	...
	.node_name{text-overflow: ellipsis;overflow: hidden;white-space: nowrap;width: 82px;}
        ...
        ztreeItem:{
            ...
            `<li :class="liClassVal">
				...
				<a :class="aClassVal" @click='Func(model)' @contextmenu.prevent='cxtmenufunc'>
					...
					<span :class="{grayColor:model.isAuth == 0}">({{model.peopleNum}}人)</span>
				</a>
