<template>
    <div class="wf-form wf-formsettings">
        <div class="wf-field wf-setting-title">
            <div class="fieldname">
                <span style="color: #000000;">审批名称</span>
                <span class="fieldinfo" style="color: #000000;">最多10个字</span>
            </div>
            <div class="fieldblock">
                <input type="text" @input="changeInfo" maxlength="10" v-model="title" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div class="wf-field wf-setting-description">
            <div class="fieldname">
                <span style="color: #000000;">审批说明</span>
                <span class="fieldinfo" style="color: #000000;">最多100个字</span>
            </div>
            <div class="fieldblock">
                <textarea type="text" @input="changeInfo" maxlength="100" v-model="description" style="border-color:#FCB298;border-radius: 4px;"></textarea>
            </div>
        </div>
