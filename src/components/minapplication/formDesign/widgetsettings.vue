    ...
    <div class="wf-form wf-widgetsettings">
        <div v-if="supportSetting.label" class="wf-field wf-setting-label">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="10" v-model="supportSetting.defaultLable" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.label2" class="wf-field wf-setting-label">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="10" v-model="supportSetting.defaultLable2" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.action" class="wf-field wf-setting-label">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="10" v-model="supportSetting.defaultAction" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.textnote" class="wf-field wf-setting-content">
            ...
            <div class="fieldblock">
                <textarea type="text" @input="changeComponent" maxlength="5000" v-model="supportSetting.defaultProps" style="border-color:#FCB298;border-radius: 4px;">
                    请输入说明文字
                </textarea>
            </div>
        </div>
        <div v-if="supportSetting.placeholder" class="wf-field wf-setting-placeholder">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="20" v-model="supportSetting.defaultProps" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.placeholder2" class="wf-field wf-setting-placeholder">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" maxlength="20" v-model="supportSetting.defaultProps2" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.href" class="wf-field wf-setting-display">
            ...
            <div class="fieldblock">
                <textarea type="text" @input="changeComponent"  v-model="supportSetting.defaultHref" style="border-color:#FCB298;border-radius: 4px;">
                </textarea>
            </div>
        </div>
            ...
            <div class="fieldname">
                <label class="fieldblock">
                    <input type="radio" name="dateformat" v-model="supportSetting.defaultFormat"
                           value="yyyy-MM-dd HH:mm" style="border-color:#FCB298;border-radius: 4px;">
                    <span class="verticalmiddle">年-月-日 时:分</span>
                </label>
                <label class="fieldblock">
                    <input type="radio" name="dateformat" v-model="supportSetting.defaultFormat" value="yyyy-MM-dd" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <div v-if="supportSetting.uint" class="wf-field wf-setting-placeholder">
            ...
            <div class="fieldblock">
                <input type="text" @input="changeComponent" v-model="supportSetting.defaulUint" style="border-color:#FCB298;border-radius: 4px;">
            </div>
        </div>
        <div v-if="supportSetting.defaultOptions" class="wf-field wf-setting-options" >
            ...
            <div
                ...
                <div v-for="(n,index) in supportSetting.defaultOptions" class="fieldblock wf-setting-options">
                    <input type="text" maxlength="20" v-model="n.text" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <div v-if="supportSetting.important" class="wf-field wf-setting-required">
            ...
            <label class="fieldblock">
                <input type="checkbox" @change="changeComponent" value="1"
                       v-model="supportSetting.defaultImportant" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <div v-if="supportSetting.translate" class="wf-field wf-setting-conformat">
            ...
            <label class="fieldblock">
                <input type="checkbox" @change="changeComponent" value="1"
                       v-model="supportSetting.defaultTranslate" style="border-color:#FCB298;border-radius: 4px;">
        ...
        <div v-if="supportSetting.autorekonTime" class="wf-field-group">
            ...
            <div class="wf-field wf-setting-duration">
                <label class="fieldblock">
                    <input type="checkbox" @change="changeComponent" value="1"
                           v-model="supportSetting.defaultAutorekonTime" style="border-color:#FCB298;border-radius: 4px;">
            ...
            <div class="wf-setting-duration-label" v-if="supportSetting.defaultAutorekonTime">
                <div class="wf-field wf-setting-label">
                    ...
                    <div class="fieldblock">
                        <input type="text" maxlength="10" v-model="supportSetting.defaultSubtitle" style="border-color:#FCB298;border-radius: 4px;">
                    </div>
                </div>
            </div>
        ...
        <div v-if="supportSetting.sync" class="wf-field wf-setting-required">
            ...
            <label class="fieldblock">
                <input type="checkbox" @change="changeComponent" value="1"
                       v-model="supportSetting.defaultSync" style="border-color:#FCB298;border-radius: 4px;">
                <span class="verticalmiddle">开启</span>
            </label>
        ...
        <div v-if="supportSetting.print" class="wf-field wf-setting-print">
            ...
            <label class="fieldblock">
                <input type="checkbox"  @change="changeComponent" value="1" v-model="supportSetting.defaultPrint" style="border-color:#FCB298;border-radius: 4px;">
